...
def constructPrintStrings_nolengths(n0,n1,n2,n3,lengths,noteseq,durseq):
    notestr ="["+ str(n3[0]) + ", " + str(n2[0]) + ", " + str(n1[0]) + ", " + str(n0[0])
    durstr ="["+ str(n3[1]) + ", " + str(n2[1]) + ", " + str(n1[1]) + ", " + str(n0[1])
    noteindex = 0
    for noteindex in range(len(noteseq)):
        notestr+=", "
...
def train_epoch(sess, trainable_model, num_iter,
    ...
    if actual_seq_print == None:
        ...
        notestr,durstr = constructPrintStrings_nolengths(supervised_n0,supervised_n1,supervised_n2,supervised_n3,supervised_lengths,actual_seq_print,actual_seq_dur)
        print(notestr)
        print(durstr)
    ...
    if sup_gen_x == None:
        ...
        notestr,durstr = constructPrintStrings_nolengths(supervised_n0,supervised_n1,supervised_n2,supervised_n3,supervised_lengths,sup_gen_x,sup_gen_x_dur)
        print(notestr)
        print(durstr)
    ...
    if unsup_gen_x == None:
        ...
        notestr,durstr = constructPrintStrings_nolengths(unsupervised_n0,unsupervised_n1,unsupervised_n2,unsupervised_n3,unsupervised_lengths,unsup_gen_x,unsup_gen_x_dur)
        print(notestr)
        print(durstr)
    print('>>>> expected rewards:', np.mean(expected_rewards, axis=0))
    return ii,direction,np.mean(supervised_g_losses),np.mean(d_losses),actual_seq_print, actual_seq_dur, sup_gen_x, sup_gen_x_dur, unsup_gen_x, unsup_gen_x_dur, \
