    ...
    def __init__(self, num_emb, num_emb_dur, num_emb_dura, num_emb_chord,
        ...
        def _newg_recurrence(ii,seq_count, beat_count, pitch_count, prev_interval, prev_pitch_chord,
            ...
            inputs_recurr = tf.reshape(
                tf.concat([rchordnote_vec,rchordkey_vec,rrep_count,rprev_interval,rprev_pitch_chord,timeTillEndVec,rx_t,rx1_t,rx2_t,rx3_t],
                ...
                #             tf.reshape(
                # tf.concat([rchordnote_vec,rchordkey_vec,rrep_count,ra_count,rprev_interval,rprev_pitch_chord,timeTillEndVec,rx_t,rx1_t,rx2_t,rx3_t,ra_t,ra1_t,ra2_t,ra3_t],
                # #tf.concat([rhigh,rlow,rchordnote_vec,rchordkey_vec,rrep_count,ra_count,rdura_count,rprev_interval,rprev_pitch_chord,rblock_input,rx_t,ra_t,rdura_t,rbeatVec],
                #     0), 
                # [self.num_inputs_block,1])
            ...
            next_token_dura = tf.constant(0,dtype=tf.int32)#tf.mod(next_token_dur + 48 - beat_count-1,tf.constant(48,dtype=tf.int32))
            ...
            newii = ii +1 # BEAT POSITION / DURATION ENCODING
        ...
        def _d_recurrence(i,seqlen,chordindex,beat_count,prev_interval, prev_pitch_chord,
            ...
            next_token_dura = tf.constant(0,dtype=tf.int32)#tf.mod(next_a+48-beat_count-1,tf.constant(48,dtype=tf.int32))
            ...
            inputs_recurr = tf.reshape(
                tf.concat([rchordnote_vec,rchordkey_vec,rrep_count,rprev_interval,rprev_pitch_chord,notesTillEndVec,rx_t,rx1_t,rx2_t,rx3_t],
                ...
                #             tf.reshape(
                # tf.concat([rchordnote_vec,rchordkey_vec,rrep_count,ra_count,rprev_interval,rprev_pitch_chord,notesTillEndVec,rx_t,rx1_t,rx2_t,rx3_t,ra_t,ra1_t,ra2_t,ra3_t],
                # #tf.concat([rhigh,rlow,rchordnote_vec,rchordkey_vec,rrep_count,ra_count,rdura_count,rprev_interval,rprev_pitch_chord,rx_t,ra_t,rdura_t,rbeatVec],
                #     0), 
                # [self.num_inputs_noblock_d,1])
            ...
            cpitch = tf.cond(tf.equal(next_token,tf.constant(self.REST_VAL,dtype=tf.int32)), lambda: tf.constant(0,dtype=tf.int32), lambda: tf.mod(12+next_token-chordkey_vec,12))
            newchordindex = tf.minimum(chordindex+1,self.chord_length-1)
